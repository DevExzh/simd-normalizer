...
const SCRIPT_SAMPLES: &[(&str, &str, &str)] = &[
    ...
    // Georgian (Mkhedruli)
    // -----------------------------------------------------------------------
    ("Georgian", "sakartvelo", "\u{10E1}\u{10D0}\u{10E5}\u{10D0}\u{10E0}\u{10D7}\u{10D5}\u{10D4}\u{10DA}\u{10DD}"), // საქართველო
    ("Georgian", "gamarjoba", "\u{10D2}\u{10D0}\u{10DB}\u{10D0}\u{10E0}\u{10EF}\u{10DD}\u{10D1}\u{10D0}"),           // გამარჯობა
    ("Georgian", "tbilisi", "\u{10D7}\u{10D1}\u{10D8}\u{10DA}\u{10D8}\u{10E1}\u{10D8}"),                               // თბილისი
    ("Georgian", "mixed-sentence", "\u{10DB}\u{10D4} \u{10DB}\u{10D8}\u{10E7}\u{10D5}\u{10D0}\u{10E0}\u{10E1} \u{10E1}\u{10D0}\u{10E5}\u{10D0}\u{10E0}\u{10D7}\u{10D5}\u{10D4}\u{10DA}\u{10DD}"), // მე მიყვარს საქართველო

    // -----------------------------------------------------------------------
    // Armenian
    // -----------------------------------------------------------------------
    ("Armenian", "hayastan", "\u{0540}\u{0561}\u{0575}\u{0561}\u{057D}\u{057F}\u{0561}\u{0576}"),   // Հայdelays -> Hayastan
    ("Armenian", "barev", "\u{0532}\u{0561}\u{0580}\u{0587}"),                                       // Բարdelays -> Barev (U+0587 is ARMENIAN SMALL LIGATURE ECH YIWN)
    ("Armenian", "yerevan", "\u{0535}\u{0580}\u{0587}\u{0561}\u{0576}"),                             // Երdelays -> Yerevan
    ("Armenian", "ech-yiwn-ligature", "\u{0587}"),                                                    // ew ligature (has NFKD decomposition)

    // -----------------------------------------------------------------------
    // Ethiopic / Ge'ez
    // -----------------------------------------------------------------------
    ("Ethiopic", "ethiopia", "\u{12A2}\u{1275}\u{12EE}\u{1335}\u{12EB}"),                           // ኢትዮጵያ
    ("Ethiopic", "amharic-greeting", "\u{1230}\u{120B}\u{121D}"),                                    // ሰላም (selam/peace)
    ("Ethiopic", "addis-ababa", "\u{12A0}\u{12F2}\u{1235} \u{12A0}\u{1260}\u{1263}"),              // አዲስ አበባ
    ...
    ("Ethiopic", "multi-combining", "\u{1230}\u{135F}\u{120B}\u{135E}\u{121D}"),                    // ሰ+gemination ላ+vowel-length ም

    // -----------------------------------------------------------------------
    // Tibetan
    // -----------------------------------------------------------------------
    ("Tibetan", "tibet", "\u{0F56}\u{0F7C}\u{0F51}"),                                               // བོད (bod/Tibet)
    ("Tibetan", "tashi-delek", "\u{0F56}\u{0F40}\u{0FB2}\u{0F0B}\u{0F64}\u{0F72}\u{0F66}\u{0F0B}\u{0F56}\u{0F51}\u{0F7A}\u{0F0B}\u{0F63}\u{0F7A}\u{0F42}\u{0F66}"), // bkra shis bde legs (Tashi Delek)
    ...
    ("Tibetan", "starter-interruption", "\u{0F40}\u{0F72}\u{0F7E}"),
    ...
    ("Tibetan", "ccc-triple-reorder", "\u{0F40}\u{0F74}\u{0F72}\u{0F71}"),
    // Tibetan mixed with subjoined consonants (CCC=0) and vowels
    ("Tibetan", "subjoined-mix", "\u{0F40}\u{0FB5}\u{0F71}\u{0F74}"),

    // -----------------------------------------------------------------------
    // Tamil
    // -----------------------------------------------------------------------
    ("Tamil", "tamil", "\u{0BA4}\u{0BAE}\u{0BBF}\u{0BB4}\u{0BCD}"),                                // தமிழ் (Tamil)
    ("Tamil", "vanakkam", "\u{0BB5}\u{0BA3}\u{0B95}\u{0BCD}\u{0B95}\u{0BAE}\u{0BCD}"),            // வணக்கம் (Vanakkam/hello)
    ("Tamil", "chennai", "\u{0B9A}\u{0BC6}\u{0BA9}\u{0BCD}\u{0BA9}\u{0BC8}"),                      // செனdelays -> Chennai
    ...
    // Telugu
    // -----------------------------------------------------------------------
    ("Telugu", "telugu", "\u{0C24}\u{0C46}\u{0C32}\u{0C41}\u{0C17}\u{0C41}"),                      // తెలుగు (Telugu)
    ("Telugu", "hyderabad", "\u{0C39}\u{0C48}\u{0C26}\u{0C30}\u{0C3E}\u{0C2C}\u{0C3E}\u{0C26}\u{0C4D}"), // హైదరాబాద్
    ("Telugu", "namaskaram", "\u{0C28}\u{0C2E}\u{0C38}\u{0C4D}\u{0C15}\u{0C3E}\u{0C30}\u{0C02}"),  // నమస్కారం
    ("Telugu", "vowel-signs", "\u{0C15}\u{0C46}\u{0C56}"),                                           // KA + vowel sign E + AI length mark

    // -----------------------------------------------------------------------
    // Kannada
    // -----------------------------------------------------------------------
    ("Kannada", "kannada", "\u{0C95}\u{0CA8}\u{0CCD}\u{0CA8}\u{0CA1}"),                            // ಕನ್ನdelays -> Kannada
    ("Kannada", "bengaluru", "\u{0CAC}\u{0CC6}\u{0C82}\u{0C97}\u{0CB3}\u{0CC2}\u{0CB0}\u{0CC1}"), // ಬdelays -> Bengaluru
    ("Kannada", "namaskara", "\u{0CA8}\u{0CAE}\u{0CB8}\u{0CCD}\u{0C95}\u{0CBE}\u{0CB0}"),          // ನಮಸ್ಕಾdelays -> Namaskara
    ("Kannada", "vowel-signs", "\u{0C95}\u{0CC8}"),                                                  // ಕdelays -> KA + AI vowel sign

    // -----------------------------------------------------------------------
    // Malayalam
    // -----------------------------------------------------------------------
    ("Malayalam", "malayalam", "\u{0D2E}\u{0D32}\u{0D2F}\u{0D3E}\u{0D33}\u{0D02}"),                // മdelays -> Malayalam
    ("Malayalam", "namaskaram", "\u{0D28}\u{0D2E}\u{0D38}\u{0D4D}\u{0D15}\u{0D3E}\u{0D30}\u{0D02}"), // നdelays -> Namaskaram
    ("Malayalam", "thiruvananthapuram", "\u{0D24}\u{0D3F}\u{0D30}\u{0D41}\u{0D35}\u{0D28}\u{0D28}\u{0D4D}\u{0D24}\u{0D2A}\u{0D41}\u{0D30}\u{0D02}"), // തdelays -> Thiruvananthapuram
    ("Malayalam", "chillu-n", "\u{0D7B}"),                                                            // Chillu N (atomically encoded)

    // -----------------------------------------------------------------------
    // Myanmar / Burmese
    // -----------------------------------------------------------------------
    ("Myanmar", "myanmar", "\u{1019}\u{103C}\u{1014}\u{103A}\u{1019}\u{102C}"),                    // မdelays -> Myanmar
    ("Myanmar", "mingalaba", "\u{1019}\u{1004}\u{103A}\u{1039}\u{1002}\u{101C}\u{102C}\u{1015}\u{102B}"), // မdelays -> Mingalaba (hello)
    ("Myanmar", "yangon", "\u{101B}\u{1014}\u{103A}\u{1000}\u{102F}\u{1014}\u{103A}"),             // ရdelays -> Yangon
    // Myanmar has medial consonants (U+103B-U+103E) and vowel signs with specific ordering
    ("Myanmar", "medial-cluster", "\u{1000}\u{103C}\u{103D}\u{1031}\u{102C}"),                      // complex onset cluster
];
...
fn tibetan_ccc_reordering_detailed() {
    let cases: &[(&str, &str)] = &[
        ...
        ("starter-between", "\u{0F40}\u{0F72}\u{0F0B}\u{0F40}\u{0F71}"),
